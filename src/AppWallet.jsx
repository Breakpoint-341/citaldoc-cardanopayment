...
buildSendADATransaction = async () => {    
    ...
    //alert('LOVELACES=' + this.state.lovelaceToSend * 1000000);
        ...
        txBuilder.add_output(        
            TransactionOutput.new(
                ...
                Value.new(BigNum.from_str((this.state.lovelaceToSend * 1000000).toString()))
            ),
        );
            ...
            <div style={{margin: "5px"}}>
                ...
                <span>
                    {this.state.submittedTxHash==0 && this.state.wallets.length > 0 ? (
                        ...
                        <div style={{marginBottom: 15}}>¿Que billetera usarás?</div>
                        <RadioGroup
                             ...
                             <span>
                                {this.state.submittedTxHash==0 && this.state.wallets.length > 0 ? (
                                    <div>                                        
                                        <span style={{textAlign: "center"}}>
                                            {this.state.balance==null || this.state.balance==undefined  ? (
                                                ...
                                                <div>
                                                    <p>Tienes {this.state.balance / 1000000} ADA disponibles. </p>
                                                    <p>¿Cuanto pagaras?</p>
                                                    <FormGroup                                
                                                        helperText=""
                                                        label=""
                                                    ...
                                                    <button style={{padding: "10px"}} onClick={this.buildSendADATransaction}>PAGAR</button> 
                                                </div>
                                            )}
                                        </span>   
                                    ...
                                    <span style={{textAlign: "center"}}>
                                        {this.state.submittedTxHash!=0 && this.state.wallets.length > 0 ? (
                                        <div>
                                            LISTO! PAGASTE CARAJOOOOOOOOO! CERRAME AHORA MIERDA!                                        
                                        </div>
                                        ) : (
                                            <div>
                                                NO SE DETECTÓ BILLETERA DE CARDANO. POR FAVOR INSTALA UNA.
                                            </div>
                                        )}
                                    </span>
                                )}
